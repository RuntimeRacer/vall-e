...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch-duration", dest="batch_duration", type=float, default=400.0, help="The maximum number of audio seconds in a batch. Determines batch size dynamically.")
